...
public class NoticeDao {
	...
	public int insertNotice(NoticeVo nVo) {
		...
		String sql = "insert into QNA values(notice_seq.nextval,?,?,?,?)";
	...
	public List<NoticeVo> getNoticeList(String column, String keyword, int page){
	...
	public NoticeVo getNextNotice(int no) {
		NoticeVo nVo = null;
		return nVo;
	}
	
	// 게시물 번호로 특정 게시물 이전 게시물 데이터 조회
	public NoticeVo getPrevNotice(int no) {
		NoticeVo nVo = null;
		return nVo;
	}	
